...
from dealer.models import DealerCar, DealerProfile, TransactionSellToShowroom
from showroom.models import ShowroomProfile, ShowroomCar, TransactionSellToCustomer
from customer.models import CustomerProfile, CustomerCar
    ...
    for showroom_item in ShowroomProfile.objects.all():
        ...
        for d_car in dealer_cars:
            ...
            with transaction.atomic():
                ...
                # add transactions
                TransactionSellToShowroom.objects.create(
                    car=showroom_car,
                    showroom=showroom_item,
                    dealer=dealer_profile,
                    price=dealer_price,
    ...
    for customer_item in CustomerProfile.objects.all():
        ...
        for sh_car in showroom_car:
            ...
            with transaction.atomic():
                ...
                # add transactions
                TransactionSellToCustomer.objects.create(
                    car=customer_car,
                    customer=customer_item,
                    showroom=showroom_profile,
                    price=showroom_price,
